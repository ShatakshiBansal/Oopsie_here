...
##Content
    ...
    def get_data(self,ev):
        ...
        self.var_sub1.set(row[3])
        self.var_sub2.set(row[4])
        self.var_sub3.set(row[5])
        self.var_sub4.set(row[6])
        self.var_sub5.set(row[7])
        self.var_sub6.set(row[8])
        self.var_obt_marks.set(row[9])
        self.var_total_marks.set(row[10])
        self.var_percentage.set(row[11])
