...
class resultClass:
    def __init__(self,root):
        ...
        #button
        btn_add=Button(self.root,text="Submit",font=('times new roam',15),bg="lightgreen",activebackground="lightgreen",cursor="hand2",command=self.add).place(x=300,y=420,width=120,height=35)
        btn_add=Button(self.root,text="Submit",font=('times new roam',15),bg="lightgray",activebackground="lightgray",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
